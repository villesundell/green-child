...
function greenchild_child_enqueue_styles() {
  ...
  wp_enqueue_style(
    ...
    'https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@400;700&family=IBM+Plex+Mono:wght@400;700&family=Barlow+Semi+Condensed:wght@400;600&display=swap',
    array(),
    null
  );
}
